...
const ProjectPreview = forwardRef<ProjectPreviewRef, ProjectPreviewProps> (({project, isGenerating, device='desktop', showEditorPanel=true}:ProjectPreviewProps,ref) => {
        ...
        {project.current_code?(
            ...
            {showEditorPanel && selectedElement && (
                ...
                onUpdate={handleUpdate} onClose={()=>{
                    setSelectedElement(null)
                    if(iframRef.current?.contentWindow){
                        iframRef.current.contentWindow.postMessage({type:'CLEAR_SELECTION_REQUEST'},'*')
                    }
                }} />
